...
var controller_1 = require("../controller/index.cjs");
var getFormInitialValues_1 = __importDefault(require("./getFormInitialValues.cjs"));
var getSimpleValidationResolver_1 = require("./validation/getSimpleValidationResolver.cjs");
var setSubmissionErrors_1 = require("./validation/setSubmissionErrors.cjs");
var useNotifyIsFormInvalid_1 = require("./validation/useNotifyIsFormInvalid.cjs");
var sanitizeEmptyValues_1 = require("./sanitizeEmptyValues.cjs");
var useRecordFromLocation_1 = require("./useRecordFromLocation.cjs");
/**
...
var useAugmentedForm = function (props) {
    var _a = props.criteriaMode, criteriaMode = _a === void 0 ? 'firstError' : _a, defaultValues = props.defaultValues, formRootPathname = props.formRootPathname, resolver = props.resolver, resetOptions = props.resetOptions, _b = props.reValidateMode, reValidateMode = _b === void 0 ? 'onChange' : _b, onSubmit = props.onSubmit, sanitizeEmptyValues = props.sanitizeEmptyValues, validate = props.validate, disableInvalidFormNotification = props.disableInvalidFormNotification, rest = __rest(props, ["criteriaMode", "defaultValues", "formRootPathname", "resolver", "resetOptions", "reValidateMode", "onSubmit", "sanitizeEmptyValues", "validate", "disableInvalidFormNotification"]);
    ...
    var finalResolver = resolver
        ...
        : validate
            ...
            : undefined;
    var form = (0, react_hook_form_1.useForm)(__assign({ criteriaMode: criteriaMode, defaultValues: defaultValuesIncludingRecord, reValidateMode: reValidateMode, resolver: finalResolver }, rest));
    var formRef = (0, react_1.useRef)(form);
    var reset = form.reset, formState = form.formState;
    var isReady = formState.isReady;
    var previousRecordId = (0, react_1.useRef)(record === null || record === void 0 ? void 0 : record.id);
    (0, react_1.useEffect)(function () {
        var recordIdChanged = (record === null || record === void 0 ? void 0 : record.id) !== previousRecordId.current;
        previousRecordId.current = record === null || record === void 0 ? void 0 : record.id;
        reset(defaultValuesIncludingRecord, recordIdChanged ? undefined : resetOptions);
    }, [defaultValuesIncludingRecord, reset, resetOptions, record === null || record === void 0 ? void 0 : record.id]);
    // notify on invalid form
    (0, useNotifyIsFormInvalid_1.useNotifyIsFormInvalid)(form.control, !disableInvalidFormNotification);
    var recordFromLocation = (0, useRecordFromLocation_1.useRecordFromLocation)();
    var recordFromLocationApplied = (0, react_1.useRef)(false);
    (0, react_1.useEffect)(function () {
        if (!isReady)
            return;
