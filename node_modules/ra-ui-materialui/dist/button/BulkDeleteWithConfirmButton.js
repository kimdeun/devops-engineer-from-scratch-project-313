...
import { useResourceContext, useTranslate, useBulkDeleteController, useListContext, } from 'ra-core';
import { Confirm } from "../layout/index.js";
import { Button } from "./Button.js";
import { humanize, inflect } from 'inflection';
export var BulkDeleteWithConfirmButton = function (inProps) {
    var props = useThemeProps({
        props: inProps,
        name: PREFIX,
    });
    var _a = props.confirmTitle, confirmTitle = _a === void 0 ? 'ra.message.bulk_delete_title' : _a, _b = props.confirmContent, confirmContent = _b === void 0 ? 'ra.message.bulk_delete_content' : _b, _c = props.confirmColor, confirmColor = _c === void 0 ? 'primary' : _c, _d = props.icon, icon = _d === void 0 ? defaultIcon : _d, _e = props.label, label = _e === void 0 ? 'ra.action.delete' : _e, _f = props.mutationMode, mutationMode = _f === void 0 ? 'pessimistic' : _f, mutationOptions = props.mutationOptions, onClick = props.onClick, rest = __rest(props, ["confirmTitle", "confirmContent", "confirmColor", "icon", "label", "mutationMode", "mutationOptions", "onClick"]);
    var selectedIds = useListContext().selectedIds;
    var _g = useBulkDeleteController(__assign(__assign({ mutationMode: mutationMode }, rest), { mutationOptions: __assign(__assign({}, mutationOptions), { onSettled: function () {
                var _a;
                var args = [];
                ...
                (_a = mutationOptions === null || mutationOptions === void 0 ? void 0 : mutationOptions.onSettled) === null || _a === void 0 ? void 0 : _a.call.apply(_a, __spreadArray([mutationOptions], args, false));
    ...
    return (React.createElement(Fragment, null,
        ...
        React.createElement(Confirm, { isOpen: isOpen, loading: isPending, title: confirmTitle, content: confirmContent, confirmColor: confirmColor, titleTranslateOptions: {
...
var sanitizeRestProps = function (_a) {
    var classes = _a.classes, label = _a.label, resource = _a.resource, successMessage = _a.successMessage, mutationOptions = _a.mutationOptions, rest = __rest(_a, ["classes", "label", "resource", "successMessage", "mutationOptions"]);
    return rest;
};
