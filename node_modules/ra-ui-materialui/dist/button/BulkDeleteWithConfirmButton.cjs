...
var layout_1 = require("../layout/index.cjs");
...
var BulkDeleteWithConfirmButton = function (inProps) {
    ...
    var _g = (0, ra_core_1.useBulkDeleteController)(__assign(__assign({ mutationMode: mutationMode }, rest), { mutationOptions: __assign(__assign({}, mutationOptions), { onSettled: function () {
                var _a;
                var args = [];
