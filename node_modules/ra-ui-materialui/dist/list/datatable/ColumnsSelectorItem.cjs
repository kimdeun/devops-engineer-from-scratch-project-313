...
var diacritic = __importStar(require("diacritic"));
var preferences_1 = require("../../preferences/index.cjs");
var ColumnsSelectorItem = function (_a) {
    ...
    var columnFilter = (0, ra_core_1.useDataTableColumnFilterContext)();
    ...
    return isColumnFiltered ? (React.createElement(preferences_1.FieldToggle, { key: columnRank, source: sourceOrLabel, label: fieldLabel, index: String(columnRank), selected: !isColumnHidden, onToggle: function () {
